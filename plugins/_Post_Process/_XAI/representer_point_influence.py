...
<<<<<<< HEAD
=======
>>>>>>> f48c72e (adjusted to resume from computation)
        if not os.path.exists(os.path.join(args.monitor_path, 'info.h5')):
=======
        if not os.path.exists(os.path.join(args.monitor_path, "info.h5")):
>>>>>>> 555adef (remove unnecessary description)
...
<<<<<<< HEAD
=======
        info = generate_feature(args)

>>>>>>> 405940a (feature extract and compute score)
=======
>>>>>>> f48c72e (adjusted to resume from computation)
=======
        print('## Compute Score')
