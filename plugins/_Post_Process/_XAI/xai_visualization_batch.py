...
def func(args):
    ...
    save_info_to_csv(args.input, args.output,
                     gradcam_file_names, column_name='Grad-CAM', insert_pos=1)
    ...
    save_info_to_csv(args.output, args.output,
                     lime_file_names, column_name='LIME', insert_pos=2)
    ...
    save_info_to_csv(args.output, args.output,
                     shap_file_names, column_name='SHAP', insert_pos=3)
    ...
    save_info_to_csv(args.output, args.output,
                     smoothgrad_file_names, column_name='SmoothGrad', insert_pos=4)


def main():
    parser = argparse.ArgumentParser(
        description='XAI Visualization (batch) (GradCAM, SHAP, LIME, SmoothGrad)\n' +
        'Grad-CAM\n' +
        '\n' +
    ...
    parser.add_argument(
        '-o', '--output', help='path to output csv file (csv) default=xai_visualization.csv', required=True, default='xai_visualization.csv')
